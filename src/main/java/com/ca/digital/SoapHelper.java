...
//	private static SPLSapCustomDataProvider customDataProvider;
...
//			
			...
			QName qName = new QName("urn:ca.com:GTS_SPL_Websevice","GTS_SPL_sync_MIService"); 
...
//			soapMsg.getMimeHeaders().addHeader("Authorization",
//					"Basic " + new String(Base64Coder.encodeString(loginPassword)));
			
			/*String encoded = Base64.getEncoder().encodeToString(("R3ALEREMOTE"+":"+"C0nn3ct1").getBytes(StandardCharsets.UTF_8));  //Java 8
			sm.setProperty("Authorization", "Basic "+"UjNBTEVSRU1PVEU6QzBubjNjdDE="); */
			
			/*sm.setProperty("client", "100");
			sm.setProperty("language", "en");
			sm.setProperty("sysNumber", "00");
			sm.setProperty("host", "dg2ci.ca.com");
			sm.setProperty("client", "100");
			sm.setProperty("Username", "R3ALEREMOTE");
			sm.setProperty("Password", "C0nn3ct1");*/
			...
			SOAPMessage response = soapConnection.call(sm, url);
...
/*	public static void main(String args[])
	{ 
		try 
	{ connectSAPserver("100", "en", "00", "dg2ci.ca.com", "R3ALEREMOTE", "C0nn3ct1"); } 
	catch
	...
	public static boolean connectSAPserver(String client, String language, String sysNumber, String host,
		...
		try {
//			JCoDestination dest = JCoDestinationManager.getDestination("SAP_SERVER");
//			connected = dest.getAttributes() != null;
	...
	private static void registerSAPServerDetails(String client, String language, String sysNumber, String host,
			String userName, String password) {
//		if (customDataProvider != null) {
//			Environment.unregisterDestinationDataProvider(customDataProvider);
//		}
//		customDataProvider = new SPLSapCustomDataProvider(client, language, sysNumber, host, userName, password);
